<template>
    <div class="content-wrapper">
        ...
        <section class="content-header" v-if="category && videos && !video">
            <h1>
                {{ category }} Video
                <small>Videos List (IMDb Corpus)</small>
            </h1>
            <ol class="breadcrumb">
                <li>
                    <router-link :to="'/'">
        ...
        <section class="content-header" v-if="video">
            <h1>
                {{ video.title }}
                <small>Video details (IMDb Corpus)</small>
            </h1>
            <ol class="breadcrumb">
                <li>
                    <router-link :to="'/'">
        ...
        <section class="content">
            ...
            <videos-list :category="category" :videos="videos" @setVideo="setVideo"
                         v-if="category && videos && !video"></videos-list>
...
<script>
    import imdb from '@/output/imdb/videos.json'
    ...
    export default {
        ...
        computed: {
            autoVideos() {
                ...
                let videos = _.filter(this.imdbBased, lookup => {
